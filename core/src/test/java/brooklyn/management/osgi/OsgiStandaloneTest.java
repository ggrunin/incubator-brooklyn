...
public class OsgiStandaloneTest {
    ...
    public void testDuplicateBundle() throws Exception {
        MavenArtifact artifact = new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.7.0-ea-cloudsoft.1"); // BROOKLYN_VERSION
    ...
    public void testRemoteDuplicateBundle() throws Exception {
        helperDuplicateBundle(MavenRetriever.hostedUrl(new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.7.0-ea-cloudsoft.1"))); // BROOKLYN_VERSION
    }
