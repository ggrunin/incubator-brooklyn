        ...
        try {
            ...
            if (persistCatalogItemsEnabled && !CatalogLoadMode.LOAD_BROOKLYN_CATALOG_URL.equals(catalogLoadMode)) {
                if (isEmpty) {
                    ...
                    LOG.debug("RebindManager loading default catalog because there is no persisted state");
                ...
                String message = "RebindManager not resetting catalog to persisted state because catalog load mode is {}. ";
