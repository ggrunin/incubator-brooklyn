...
/**
 * Generates the {@code server.conf} configuration file using sensors on an {@link HAProxyController}.
 */
public class HAProxyDefaultConfigGenerator implements HAProxyConfigFileGenerator {

    private static final Logger LOG = LoggerFactory.getLogger(HAProxyDefaultConfigGenerator.class);

    public HAProxyDefaultConfigGenerator() { }
