...
public class MavenArtifactTest {
    ...
    final static String THIS_PROJECT_COORDINATE = "org.apache.brooklyn:brooklyn-utils-common:jar:0.7.0-ea-cloudsoft.1";  // BROOKLYN_VERSION
    ...
    public void testRetrievalHostedSnapshotIntegration() throws Exception {
        MavenArtifact m = MavenArtifact.fromCoordinate(
                "org.apache.brooklyn:brooklyn-utils-common:jar:0.7.0-ea-cloudsoft.1");  // BROOKLYN_VERSION
